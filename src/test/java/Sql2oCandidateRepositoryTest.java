...
public class Sql2oCandidateRepositoryTest {
    ...
    public void whenSaveThenGetSame() {
        ...
        var candidate = sql2oCandidateRepository.save(new Candidate(0, "Ivan", "description", creationDate, 1, file.getId()));
    ...
    public void whenSaveSeveralThenGetAll() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var candidate1 = sql2oCandidateRepository.save(new Candidate(0, "Ivan", "descriptionZero", creationDate, 1, file.getId()));
        var candidate2 = sql2oCandidateRepository.save(new Candidate(1, "Sergei", "descriptionFirst", creationDate, 2, file.getId()));
        var candidate3 = sql2oCandidateRepository.save(new Candidate(2, "Vadim", "descriptionSecond", creationDate, 3, file.getId()));
